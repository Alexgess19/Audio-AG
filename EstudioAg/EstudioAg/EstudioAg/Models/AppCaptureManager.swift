...
class AppCaptureSession: NSObject, SCStreamOutput {
    ...
    func start() async throws {
        ...
        // [FIX-VIDEO] Ya no solicitamos el stream de `.screen`.
        // Al tener capturesVideo = false, SCKit no genera frames de video,
        // no pide permisos de video innecesarios y lo más importante:
        // no detiene la transmisión cuando la pantalla se apaga.
